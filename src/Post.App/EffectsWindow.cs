...
internal sealed record EffectHost(
    Action<EffectsWindow.EffectOptions> ApplyPreset,
...
internal sealed class EffectsWindow : Window
{
    ...
    public EffectsWindow(EffectHost host)
    {
        _host = host; Title = "Effects"; Width = 660; Height = 660; MinWidth = 540; MinHeight = 460;
        ...
        Grid.SetColumn(scroll, 2); root.Children.Add(scroll); Content = root;
    ...
    private void EditEffect(VideoEffect effect, bool wholeTimeline)
    {
        ...
        var editor = new EffectEditorWindow(draft, _host.SetPreview, this);
    ...
    {
        _options.Children.Add(Heading("EFFECT OPTIONS"));
        _parameters = new EffectParameterPanel(kind, null, this);
    ...
    {
        if (_parameters is null || !_parameters.Validate(this)) return;
